...
def global_changes():
    """
    Функция, которая изменяет и возвращает переменные, определенные в глобальной области видимости модуля
    :return number, string: переменные, определенные в глобальной области видимости модуля
    """
    global number
    number = 5
    global string
